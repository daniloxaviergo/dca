...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [x] #1 Display 'Enter DCA Entry' header with visual styling
- [x] #2 Prompt for amount and accept user input (must be positive number)
- [x] #3 Prompt for date with default value of today (RFC3339 format)
- [x] #4 Prompt for asset ticker (e.g., BTC, ETH) and validate as non-empty string
- [x] #5 Prompt for price per share and accept user input (must be positive number)
- [x] #6 Calculate and display shares (Amount / Price) with 8 decimal precision
- [x] #7 Display summary of all entered values for confirmation
- [x] #8 Support Ctrl+C to cancel without saving
- [x] #9 Use BubbleTea framework for TUI interaction
- [x] #10 Handle validation errors with clear error messages and re-prompt
<!-- AC:END -->
