...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 - [x] #1 Entries in asset history modal are sorted in descending order (newest first)
- [ ] #2 - [x] #2 Total Invested shows cumulative sum of all previous days (running total)
<!-- AC:END -->
